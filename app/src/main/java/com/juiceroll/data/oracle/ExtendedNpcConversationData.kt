 ...
 */
object ExtendedNpcConversationData {
    /** Type of Information (1d100) - What kind of information the NPC provides */
    val informationTypes: List<String> = listOf(
    ...
    val informationTopics: List<String> = listOf(
        "a beloved NPC",                                      // 1-3
        "a beloved NPC",
        "a beloved NPC",
    ...
    val companionResponses: List<String> = listOf(
    ...
    val dialogTopics: List<String> = listOf(
